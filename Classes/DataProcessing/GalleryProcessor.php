...
$this->defaultImgWidthBig = $this->getConfigurationValue('defaultImgWidthBig') ? (int)$this->getConfigurationValue('defaultImgWidthBig') : 0;
$this->defaultImgWidthSmall = $this->getConfigurationValue('defaultImgWidthSmall') ? (int)$this->getConfigurationValue('defaultImgWidthSmall') : 0;
...
if ( $this->beLayout == 'OneCol' ) {
	$this->equalMediaWidth = (int)$this->equalMediaWidth > (int)$galleryWidthMinusBorderAndSpacing ? (int)$galleryWidthMinusBorderAndSpacing : $this->equalMediaWidth;
} else {
	if ($this->colPos == 0) {
		$this->equalMediaWidth = (int)$this->equalMediaWidth >= $this->defaultImgWidthBig ? $this->defaultImgWidthBig : $this->equalMediaWidth;
	} elseif ($this->colPos == 1 || $this->colPos == 2) {
		$this->equalMediaWidth = (int)$this->equalMediaWidth >= $this->defaultImgWidthSmall ? $this->defaultImgWidthSmall : $this->equalMediaWidth;
